<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="blog_detail.aspx.cs" Inherits="Stylique_Fashion.blog_detail" %>
    ...
    <header>
        ...
        <div class="container-menu-desktop">
            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop container">
                    ...
                    </a>&nbsp;<!-- Menu desktop --><div class="menu-desktop">
                        <ul class="main-menu">
                            <li class="active-menu"><a href="index.aspx">Home</a>
                                <ul class="sub-menu">
                                    <li><a href="index.aspx">Homepage 1</a></li>
                                    <li><a href="home2.aspx">Homepage 2</a></li>
                                    <li><a href="home3.aspx">Homepage 3</a></li>
                                </ul>
                            </li>
                            <li><a href="product.aspx">Shop</a> </li>
                            <li class="label1" data-label1="hot"><a href="shoping_cart.aspx">Features</a> </li>
        ...
        <div class="menu-mobile">
            ...
            <ul class="main-menu-m">
                ...
                <li><a href="product.aspx">Shop</a> </li>
                <li><a href="shoping_cart.aspx" class="label1 rs1" data-label1="hot">Features</a> </li>
                <li><a href="blog.aspx">Blog</a> </li>
                <li><a href="about.aspx">About</a> </li>
                <li><a href="contact.aspx">Contact</a> </li>
            </ul>
...
<asp:Content ID="Content6" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    ...
    <div class="container">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="blog.html" class="stext-109 cl8 hov-cl1 trans-04">Blog
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>

            <span class="stext-109 cl4">8 Inspiring Ways to Wear Dresses in the Winter
            </span>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="p-r-45 p-r-0-lg">
                        ...
                        <div class="wrap-pic-w how-pos5-parent">
                            ...
                            <div class="flex-col-c-m size-123 bg9 how-pos5">
                                <span class="ltext-107 cl2 txt-center">22
                                </span>

                                <span class="stext-109 cl3 txt-center">Jan 2018
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-t-32">
                            <span class="flex-w flex-m stext-111 cl2 p-b-19">
                                ...
                                <span>StreetStyle, Fashion, Couple  
									<span class="cl12 m-l-4 m-r-6">|</span>
                                </span>
                            ...
                            <h4 class="ltext-109 cl2 p-b-28">8 Inspiring Ways to Wear Dresses in the Winter
                            </h4>
                        ...
                        <div class="flex-w flex-t p-t-16">
                            <span class="size-216 stext-116 cl8 p-t-4">Tags
                            </span>
                        ...
                        <!--  -->
                        <div class="p-t-40">
                            <h5 class="mtext-113 cl2 p-b-12">Leave a Comment
                            </h5>
                ...
                <div class="col-md-4 col-lg-3 p-b-80">
                    <div class="side-menu">
                        ...
                        <div class="p-t-55">
                            <h4 class="mtext-112 cl2 p-b-33">Categories
                            </h4>

                            <ul>
                                <li class="bor18">
                                    <a href="#" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">Fashion
                                    </a>
                                </li>

                                <li class="bor18">
                                    <a href="#" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">Beauty
                                    </a>
                                </li>

                                <li class="bor18">
                                    <a href="#" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">Street Style
                                    </a>
                                </li>

                                <li class="bor18">
                                    <a href="#" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">Life Style
                                    </a>
                                </li>

                                <li class="bor18">
                                    <a href="#" class="dis-block stext-115 cl6 hov-cl1 trans-04 p-tb-8 p-lr-4">DIY & Crafts
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="p-t-65">
                            <h4 class="mtext-112 cl2 p-b-33">Featured Products
                            </h4>
                        ...
                        <div class="p-t-55">
                            <h4 class="mtext-112 cl2 p-b-20">Archive
                            </h4>
                        ...
                        <div class="p-t-50">
                            <h4 class="mtext-112 cl2 p-b-27">Tags
                            </h4>
